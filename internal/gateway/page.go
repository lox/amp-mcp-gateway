...
<!doctype html>
<html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Amp MCP Gateway · Activity</title><style>
...
.permissions{max-width:820px;margin:auto}.connection-heading{display:flex;justify-content:space-between;align-items:center;gap:20px;margin:18px 0 6px}.connection-heading h1{margin:0;font-size:28px;overflow-wrap:anywhere}.auth-status{flex-shrink:0;font-size:13px;list-style:none;border:1px solid #bccdc0;border-radius:6px;padding:8px 12px;cursor:pointer;color:#226a4d}.auth-status::-webkit-details-marker{display:none}.auth-status:before{content:'●';margin-right:8px}.auth-status.pending{color:#77550b}.auth-details{max-width:440px}.auth-details[open]{align-self:flex-start}.auth-details .help{font-size:13px}.auth-details summary:focus-visible,button:focus-visible,.button:focus-visible{outline:2px solid #216442;outline-offset:3px}.permission-default{border:0;padding:0;margin:38px 0 28px;min-width:0}.permission-default legend{font-size:16px;font-weight:650;padding:0}.permission-default .help{font-size:14px;margin:8px 0 16px}.default-options{display:flex;border:1px solid #bccdc0;border-radius:6px;overflow:hidden;background:white}.default-options label{position:relative;flex:1;text-align:center;cursor:pointer}.default-options label+label{border-left:1px solid #bccdc0}.default-options input{position:absolute;opacity:0;width:1px;height:1px}.default-options span{display:flex;align-items:center;justify-content:center;min-height:44px;padding:8px;font-size:14px;height:100%}.default-options input:checked+span{background:#216442;color:white}.default-options input:focus-visible+span{outline:2px solid #172b26;outline-offset:-4px}.default-warning{color:#9c3724}.permissions .note{margin:24px 0}.exceptions-card{border-radius:7px;padding:22px;margin:24px 0}.exceptions-heading{display:flex;align-items:start;justify-content:space-between;gap:16px;margin-bottom:22px}.exceptions-heading h2{margin:6px 0 0;font-size:18px}.refresh-tools{text-align:right}.refresh-tools button{padding:7px 12px;font-size:13px}.refresh-tools .help{margin:6px 0 0;font-size:12px}.exception-search{display:flex;gap:12px;margin-bottom:16px}.exception-search input{flex:1;min-width:0;font-size:14px}.exception-search button{white-space:nowrap;font-size:14px}.policy-columns,.policy-row{display:grid;grid-template-columns:minmax(0,1fr) 210px 32px;gap:14px;align-items:center}.policy-columns{background:#f5f7f3;padding:10px 8px;border-block:1px solid #e7ebe5;font-size:12px}.policy-row{padding:12px 8px;border-bottom:1px solid #e7ebe5}.policy-row summary{overflow-wrap:anywhere;font-size:14px;cursor:pointer}.policy-row details p{font-size:13px;line-height:1.5;overflow-wrap:anywhere}.policy-row select{font-size:13px;padding:9px 10px}.policy-row pre{padding:12px}.remove-exception{padding:6px;border:0;background:transparent;line-height:1;display:flex;justify-content:center}.remove-exception svg{width:17px;height:17px}.tool-select{display:none}.permissions input[type=checkbox]{width:16px;height:16px;margin:0;accent-color:#216442}.bulk-mode .policy-columns,.bulk-mode .policy-row{grid-template-columns:20px minmax(0,1fr) 210px 32px}.bulk-mode .tool-select{display:block}.bulk-actions{display:flex;align-items:center;flex-wrap:wrap;gap:8px;margin:16px 0;font-size:13px}.bulk-actions button{font-size:12px;padding:7px 10px}.bulk-actions span{margin-right:auto}.tool-navigation{display:flex;flex-wrap:wrap;align-items:center;gap:16px;margin-top:18px;font-size:13px}.text-button{border:0;padding:0;background:transparent;color:#226a4d;text-decoration:underline;font-size:13px}.tool-navigation .help{margin:0;margin-right:auto;font-size:12px}.policy-footer .help{font-size:12px}.policy-footer .actions{margin-top:28px}.visually-hidden{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip-path:inset(50%);white-space:nowrap;border:0}[hidden]{display:none!important}@media(max-width:600px){.connection-heading{align-items:flex-start;flex-direction:column;gap:12px}.auth-details{max-width:100%}.exceptions-card{padding:16px}.policy-columns,.policy-row{grid-template-columns:minmax(0,1fr) 32px;gap:10px}.policy-columns .permission-column{display:none}.policy-row details{grid-column:1}.policy-row .policy-choice{grid-column:1;grid-row:2}.policy-row .remove-exception{grid-column:2;grid-row:2}.bulk-mode .policy-columns,.bulk-mode .policy-row{grid-template-columns:20px minmax(0,1fr) 32px}.bulk-mode .policy-row details,.bulk-mode .policy-row .policy-choice{grid-column:2}.bulk-mode .policy-row .remove-exception{grid-column:3}.exception-search{flex-wrap:wrap}.exception-search input{flex-basis:100%}.default-options span{font-size:12px}.exceptions-heading{gap:8px}.refresh-tools{max-width:55%}}
.connection-status{margin:16px 0;display:flex;align-items:start;justify-content:space-between;gap:16px;flex-wrap:wrap}.connection-health{min-width:0;flex:1}.connection-health .help{font-size:13px;margin:10px 0}.health-times{font-size:12px;color:#586b62}.health-times p{margin:5px 0}.connection-test.actions{margin:0;gap:8px}.connection-test button:disabled{cursor:wait;opacity:.65}.health-details summary{white-space:nowrap}.health-details summary:focus-visible{outline:2px solid #216442;outline-offset:3px}.health-warning{max-width:46ch}.connection-list{background:white;border:1px solid #dbe1d9;border-radius:10px;margin:16px 0;overflow:hidden}.connection-row{display:grid;grid-template-columns:180px minmax(0,1fr) auto;gap:20px;align-items:start;padding:20px;border-bottom:1px solid #e7ebe5}.connection-row:last-child{border:0}.connection-identity{overflow-wrap:anywhere}.connection-identity .sub{font-size:13px;margin:6px 0 0}.connection-row .connection-status{margin:0;display:contents}.connection-row .connection-health{grid-column:2;grid-row:1}.connection-row .connection-test{grid-column:3;grid-row:1;padding-right:116px}.connection-row>.button{grid-column:3;grid-row:1;justify-self:end}.connection-row button,.connection-row .button{font-size:13px;padding:8px 10px}.connection-row .test-error{grid-column:2 / -1;margin:0}.connection-columns{display:grid;grid-template-columns:180px 1fr auto;gap:20px;padding:12px 20px;background:#f5f7f3;color:#66756d;font-size:12px}.connection-columns span:last-child{width:350px}@media(max-width:900px){.connection-row{grid-template-columns:minmax(0,1fr) minmax(0,1fr)}.connection-columns{display:none}.connection-row .connection-test{grid-column:1 / -1;grid-row:2;justify-content:flex-start}.connection-row>.button{grid-column:1 / -1;grid-row:2}.connection-row .test-error{grid-column:1 / -1}.connection-status{flex-direction:column}}@media(max-width:400px){.connection-row .connection-test{padding-right:0}.connection-row>.button{grid-row:3;justify-self:start}}
@media(max-width:600px){.connection-row{grid-template-columns:minmax(0,1fr);gap:14px}.connection-row .connection-health{grid-column:1;grid-row:2}.connection-row .connection-test{grid-row:3;padding-right:0}.connection-row>.button{grid-row:4;justify-self:start}}
</style></head><body><header><a href="/">Amp MCP Gateway</a><small>Single-owner preview{{if not .Operation}} · {{.Owner}}{{end}}</small><form method="post" action="/logout"><button>Sign out</button></form></header><main>
{{if .AddConnection}}
...
{{if .Connection.OAuth}}<details><summary>OAuth settings</summary><p class="help endpoint">Authorization server: {{.Connection.AuthURL}}</p><p class="help">Requested scopes: <code>{{.Connection.Scopes}}</code></p></details>{{end}}
...
<p class="note">Changed allowed tools require approval again. Blocked tools stay blocked.</p>
...
<section class="operation"><style>.operation{max-width:860px;margin:auto;overflow-wrap:anywhere}.operation h1{text-transform:capitalize}.operation .heading h1{margin-top:18px}.operation h2{margin-top:0}.operation summary{font-weight:600}.operation details.card{padding:18px 24px}.operation pre{line-height:1.65;font-size:13px}.operation .attribution{font-size:14px;margin:22px 0}.operation .result pre{background:#f7f9f5;border:1px solid #e7ebe5}.operation .result details{margin-top:24px}.operation .result summary{font-size:13px;color:#586b62}.amp-context{background:#f2f5ef;border-radius:8px;padding:16px;margin:18px 0}.amp-context dl{grid-template-columns:110px 1fr;margin:0}.approval-actions{align-items:flex-end}.approval-form{display:flex;align-items:flex-end;gap:16px;flex:1}.approval-scope{border:0;padding:0;margin:24px 0 0;min-width:0;flex:1}.approval-scope legend{font-weight:650;margin-bottom:12px}.scope-options{display:flex;flex-wrap:wrap;gap:12px 22px}.scope-option{display:inline-flex;align-items:center;gap:7px;cursor:pointer;white-space:nowrap}.scope-option input{width:16px;height:16px;margin:0;accent-color:#216442}.scope-help{color:#586b62;font-size:13px;line-height:1.5;margin:10px 0 0}@media(max-width:600px){.amp-context dl{grid-template-columns:1fr}.approval-form{display:grid;width:100%}.approval-form .primary{width:100%}}</style>
<a href="/">← All activity</a><div class="heading"><h1>{{$.Title}}</h1><span class="badge {{.Status}}" role="status">{{.Status}}</span></div>
...
<div class="actions approval-actions"><form class="approval-form" method="post" action="/operations/{{.ID}}/approve"><fieldset class="approval-scope"><legend>Approve for</legend><div class="scope-options"><label class="scope-option"><input type="radio" name="scope" value="once" data-help="Authorise only this exact stored request." checked><span>Once</span></label>{{if .AmpThreadID}}<label class="scope-option"><input type="radio" name="scope" value="thread" data-help="Allow future calls to {{.Tool}} in this thread."><span>This thread</span></label>{{end}}{{if .AmpProjectID}}<label class="scope-option"><input type="radio" name="scope" value="project" data-help="Allow future calls to {{.Tool}} across threads in this project."><span>This project</span></label>{{end}}</div><p class="scope-help" aria-live="polite">Authorise only this exact stored request.</p></fieldset><button class="primary">Approve</button></form><form method="post" action="/operations/{{.ID}}/deny"><button class="danger">Deny</button></form></div></div>
<script>
(() => {
...
{{else if or (eq .Status "ready") (eq .Status "running")}}{{if .ApprovalScope}}<p class="success">Authorised by the standing approval for this {{.ApprovalScope}}.</p>{{end}}<p class="sub">Refresh to see the latest execution status.</p><a class="button" href="/operations/{{.ID}}">Refresh status</a>
...
<details class="card"><summary>Identity &amp; audit</summary><dl><dt>On behalf of</dt><dd>{{.Subject}}</dd>{{if .AmpUserID}}<dt>Amp user</dt><dd><code>{{.AmpUserID}}</code> (verified)</dd>{{end}}{{if .AmpWorkspaceID}}<dt>Amp workspace</dt><dd><code>{{.AmpWorkspaceID}}</code> (verified)</dd>{{end}}{{if .AmpProjectID}}<dt>Amp project</dt><dd><code>{{.AmpProjectID}}</code> (verified)</dd>{{end}}{{if .AmpThreadID}}<dt>Amp thread</dt><dd><code>{{.AmpThreadID}}</code> (verified)</dd>{{end}}{{if .ApprovalScope}}<dt>Standing approval</dt><dd>This {{.ApprovalScope}} · <code>{{.ApprovalGrant}}</code></dd>{{end}}<dt>Upstream account</dt><dd>{{.Account}} <small>(configured label, not verified identity)</small></dd><dt>Calling model</dt><dd>{{if .Model}}{{.Model}} — client-reported, unverified{{else}}Unknown — not supplied by client{{end}}</dd><dt>Request digest</dt><dd><code>{{.Digest}}</code></dd></dl></details></section>{{end}}
{{else}}<h1>Connections and activity</h1><p class="sub">Choose the tools agents can use. Review calls that need your approval.</p><div class="heading"><h2>Connections</h2><a class="button primary" href="/connections/new">Add MCP</a></div><div class="connection-list">{{if .Connections}}<div class="connection-columns" aria-hidden="true"><span>Connection</span><span>Status · expand for details</span><span>Actions</span></div>{{end}}{{range .Connections}}<div class="connection-row"><div class="connection-identity"><strong>{{.ID}}</strong><p class="sub">{{.Account}}</p></div>
{{template "connection-health" .}}
<a class="button" href="/connections/{{.ID}}/tools">Manage tools</a></div>{{else}}<div class="card"><p>No MCP servers connected yet.</p><p class="sub">Add a server, connect credentials, then review its tools.</p></div>{{end}}</div><h2>Standing approvals</h2><div class="card scroll">{{if .ApprovalGrants}}<table><thead><tr><th>Tool</th><th>Scope</th><th>Amp context</th><th></th></tr></thead><tbody>{{range .ApprovalGrants}}<tr><td><code>{{.Tool}}</code></td><td>{{if eq .Scope "thread"}}This thread{{else}}This project{{end}}</td><td>{{if eq .Scope "thread"}}<a href="https://ampcode.com/threads/{{.AmpThreadID}}">{{.AmpThreadID}}</a>{{else}}Project <code>{{.AmpProjectID}}</code>{{if .AmpWorkspaceID}}<br><small>Workspace <code>{{.AmpWorkspaceID}}</code></small>{{end}}{{end}}</td><td><form method="post" action="/approval-grants/{{.ID}}/revoke"><button class="danger">Revoke</button></form></td></tr>{{end}}</tbody></table>{{else}}<p class="sub">No standing approvals. Thread and project approvals created during review appear here.</p>{{end}}</div><h2>Operations</h2><div class="card scroll">{{if .Operations}}<table><thead><tr><th>Request</th><th>Tool</th><th>Account</th><th>Status</th></tr></thead><tbody>{{range .Operations}}<tr><td><a href="/operations/{{.ID}}">{{.ID}}</a></td><td>{{.Tool}}</td><td>{{.Account}}</td><td><span class="badge {{.Status}}">{{.Status}}</span></td></tr>{{end}}</tbody></table>{{else}}<p class="sub">No operations yet. Connect an MCP client and use find_tools, then call_tools.</p>{{end}}</div><h2>Audit trail</h2><div class="card scroll"><table><thead><tr><th>Sequence</th><th>Operation</th><th>Transition</th><th>Actor</th></tr></thead><tbody>{{range .Events}}<tr><td>{{.Sequence}}</td><td><a href="/operations/{{.Operation}}">{{.Operation}}</a></td><td>{{.Kind}}</td><td>{{.Actor}}</td></tr>{{else}}<tr><td colspan="4">No events yet.</td></tr>{{end}}</tbody></table></div>{{end}}
...
document.querySelectorAll('.connection-test').forEach(form => form.addEventListener('submit', async event => {
  ...
  try {
    const response = await fetch(form.action, {method: 'POST', headers: {Accept: 'text/vnd.gateway.health+html'}});
    if (!response.ok || response.redirected) throw new Error('test failed');
    const health = section.querySelector('.connection-health'), expanded = health.querySelector('details')?.open;
    health.innerHTML = await response.text();
    if (expanded) health.querySelector('details').open = true;
  } catch (_) {
    error.textContent = 'Could not complete the test. Check your session and try again. Your tool permissions are unchanged.';
    error.hidden = false;
